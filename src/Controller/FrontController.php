...
/*
    ...
    public function other($section,OffreRepository $o,CandidatureRepository $c,CandidatureRepository $cp,CandidatureRepository $cr,CandidatureRepository $ca): Response
    {
       // OffreRepository $o;
      //  $o = new OffreRepository; 
        $offres= $o->findAll();
